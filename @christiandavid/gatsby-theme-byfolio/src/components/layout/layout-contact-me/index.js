...
const LayoutContactMe = ({ children, bgClassName }) => {
  ...
  function svgIcos() {
    ...
    c3.2,0,6.5-1.2,9-3.5l33.7-30.2l120.2,114.2c2.6,2.5,6,3.7,9.3,3.7c3.6,0,7.1-1.4,9.8-4.2c5.1-5.4,4.9-14-0.5-19.1L304.8,238.55z"
          ...
          <symbol id="icon-stack-overflow" viewBox="0 0 384 512">
        ...
        <div className={`contact${isContactOpen ? " contactme-open" : ""}`}>
          ...
          <div className="contactme-container">
            <div css={styles.contactMe}>
              Let's Make Somethign Great Together
            </div>
            <div className="contactme-info">
              ...
              <p>
                <a
                  target="_blank"
                  href="https://github.com/christiandavid"
                ...
                <a
                  target="_blank"
                  href="https://twitter.com/ichristiandavid"
                  css={styles.whiteLink}
                  rel="noreferrer"
                >
                  <svg className="icon">
                ...
                <a
                  target="_blank"
                  href="https://stackoverflow.com/users/967956/christian-david"
                  css={styles.whiteLink}
                  rel="noreferrer"
                  title="Stackoverflow Account"
                >
                  <svg className="icon">
                    <use xlinkHref="#icon-stack-overflow"></use>
                  </svg>
                </a>
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/christianibarguen/"
                  css={styles.whiteLink}
                  rel="noreferrer"
